          ...
          <Col lg="6">
            <Row>
              <Col md="6" className="mb-4 d-flex align-items-stretch">
                <Card>
                  <CardBody className="d-flex flex-column">
                    <Title className="h4">Novas regras para as eleições 2020</Title>
              ...
              <Col md="6" className="mb-4 d-flex align-items-stretch">
                <Card>
                  <CardBody className="d-flex flex-column">
                    <Title className="h4">Fundo Eleitoral</Title>
              ...
              <Col md="6" className="mb-4 d-flex align-items-stretch">
                <Card>
                  <CardBody className="d-flex flex-column">
                    <Title className="h4">Cotas de gênero em eleições</Title>
              ...
              <Col md="6" className="mb-4 d-flex align-items-stretch">
                <Card>
                  <CardBody className="d-flex flex-column">
                    <Title className="h4">5 séries sobre política</Title>
